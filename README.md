...
> Версия `v0.1.0-beta.5` добавляет проверенный русский запуск, отдельный игровой ярлык и двухшаговый режим GearUP, не изменяя пользовательские конфиги. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.5.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.5
.\scripts\package_release.ps1 -Version 0.1.0-beta.5 -PythonCommand "py"
```
