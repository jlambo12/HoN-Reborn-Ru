...
> Версия `v0.1.0-beta.10` восстанавливает перевод старых экранов, исправляет профиль настроек и сохраняет вход в аккаунт. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.10.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.10
.\scripts\package_release.ps1 -Version 0.1.0-beta.10 -PythonCommand "py"
```
