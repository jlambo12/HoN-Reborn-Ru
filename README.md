...
> Версия `v0.1.0-beta.1` — первый публичный beta-релиз. Автоматические проверки проходят; часть экранов после авторизации и матчей ещё требует ручного визуального QA. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.1.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.1
.\scripts\package_release.ps1 -Version 0.1.0-beta.1 -PythonCommand "py"
```
