...
> Версия `v0.1.0-beta.19` исправляет магазин и точечные ошибки перевода, сохраняя готовую базу и HoN Plus. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.19.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.19
.\scripts\package_release.ps1 -Version 0.1.0-beta.19 -PythonCommand "py"
```
