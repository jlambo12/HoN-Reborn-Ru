...
> Версия `v0.1.0-beta.13` завершает перевод магазина, профиля, системы чести и игровых оповещений, а Launcher сохраняет привязку голосового чата. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.13.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.13
.\scripts\package_release.ps1 -Version 0.1.0-beta.13 -PythonCommand "py"
```
