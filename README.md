...
> Версия `v0.1.0-beta.8` сохраняет пользовательские настройки игры, убирает устаревшие игровые экраны из архива и исправляет найденные в beta.7 строки. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.8.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.8
.\scripts\package_release.ps1 -Version 0.1.0-beta.8 -PythonCommand "py"
```
...
- локализация устанавливается отдельным архивом `resources_ru0.jz` рядом с основным архивом игры;
- основной `resources0.jz` и пользовательские конфиги не изменяются;
