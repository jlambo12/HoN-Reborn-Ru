...
> Версия `v0.1.0-beta.11` исправляет поиск обновлений Launcher и включает все исправления перевода, профиля настроек и входа из beta.10. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.11.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.11
.\scripts\package_release.ps1 -Version 0.1.0-beta.11 -PythonCommand "py"
```
