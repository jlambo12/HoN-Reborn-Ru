...
> Версия `v0.1.0-beta.7` получила полностью переработанный игровой Launcher `1.0.6`, сохранив проверенный запуск на русском и сценарий GearUP. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.7.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.7
.\scripts\package_release.ps1 -Version 0.1.0-beta.7 -PythonCommand "py"
```
