...
> Версия `v0.1.0-beta.20` обновляет Launcher до 1.0.14 и исправляет проверку обновлений при неработающем системном прокси. Перевод полностью совпадает с beta.19. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.20.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.20
.\scripts\package_release.ps1 -Version 0.1.0-beta.20 -PythonCommand "py"
```
