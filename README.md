...
> Версия `v0.1.0-beta.22` совместима с HoN Reborn 0.12.8, переводит новый интерфейс и обновляет Launcher до 1.0.16. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.22.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.22
.\scripts\package_release.ps1 -Version 0.1.0-beta.22 -PythonCommand "py"
```
