...
> Версия `v0.1.0-beta.4` восстанавливает повреждённые ранними beta-версиями игровые конфиги, сохраняет их кодировку и добавляет тематическую иконку. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.4.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.4
.\scripts\package_release.ps1 -Version 0.1.0-beta.4 -PythonCommand "py"
```
