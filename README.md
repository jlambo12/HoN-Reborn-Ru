...
> Версия `v0.1.0-beta.12` точечно исправляет оставшиеся английские элементы главного меню, выбора игры, ролей, стартового предупреждения и описания боссов. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.12.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.12
.\scripts\package_release.ps1 -Version 0.1.0-beta.12 -PythonCommand "py"
```
