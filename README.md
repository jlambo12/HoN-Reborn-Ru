...
> Версия `v0.1.0-beta.17` обновляет Launcher до 1.0.13: ограничивает ожидание GitHub и объединяет проверку с предложением установки. Перевод полностью совпадает с beta.16. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.17.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.17
.\scripts\package_release.ps1 -Version 0.1.0-beta.17 -PythonCommand "py"
```
