...
> Версия `v0.1.0-beta.14` добавляет поддержку HoN 0.12.6, перевод нового героя Succubus и страницы патча. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.14.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.14
.\scripts\package_release.ps1 -Version 0.1.0-beta.14 -PythonCommand "py"
```
