...
> Версия `v0.1.0-beta.15` исправляет установку обновления через Launcher и включает перевод Succubus и патча HoN 0.12.6. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.15.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.15
.\scripts\package_release.ps1 -Version 0.1.0-beta.15 -PythonCommand "py"
```
