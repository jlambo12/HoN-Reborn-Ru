...
> Версия `v0.1.0-beta.16` восстанавливает накопленный перевод интерфейса после обновления HoN 0.12.6 и исправляет профиль, систему чести, матчмейкинг и новости дня. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.16.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.16
.\scripts\package_release.ps1 -Version 0.1.0-beta.16 -PythonCommand "py"
```
