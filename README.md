...
> Версия `v0.1.0-beta.21` совместима с HoN Reborn 0.12.8, переводит новый интерфейс и обновляет Launcher до 1.0.15. Подробности — в [заметках к релизу](docs/release-notes/v0.1.0-beta.21.md).
...
```powershell
py -3.14 tools/verify_release.py --version 0.1.0-beta.21
.\scripts\package_release.ps1 -Version 0.1.0-beta.21 -PythonCommand "py"
```
