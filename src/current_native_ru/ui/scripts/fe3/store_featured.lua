...
local BANNER_PRODUCTS =
{
	...
	{
		name = 'Katana Kane',
		key = 'Hero.Kane.Katana',
		priceKeys = { 'Hero.Kane.Katana' },
		rarity = 'epic',
		route = { tab = Enum.StoreTabs.Avatars },
	...
	{
		name = 'Demon Emerald Warden',
		key = 'Hero.EmeraldWarden.Demon',
		priceKeys = { 'Hero.EmeraldWarden.Demon' },
		rarity = 'legendary',
		route = { tab = Enum.StoreTabs.Avatars },
...
local GRID_PRODUCTS =
{
	...
	{ name = 'Dark Mana Magebane', key = 'Hero.Magebane.DarkMana', new = false },
	{ name = 'Angel Of Death Shadowblade', key = 'Hero.ShadowBlade.AngelOfDeath', new = false },
